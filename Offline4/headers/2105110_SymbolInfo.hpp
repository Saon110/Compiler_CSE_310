...
public:
    ...
    SymbolInfo(string name, string type,bool isArray,bool isGlobal,bool isFunction,bool isParameter,int offset, SymbolInfo *next = nullptr)
    {
        this->name = name;
        this->type = type;
